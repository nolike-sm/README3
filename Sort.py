...
Длина массива: 7
[47, 23, 81, 12, 56, 33, 95]

ФИНАЛЬНЫЙ РЕЗУЛЬТАТ: [12, 23, 33, 47, 56, 81, 95]
...
========================================
Начальный массив: [47, 23, 81, 12, 56, 33, 95]
Рекурсивный вызов для [47, 23, 81, 12, 56, 33, 95]
Разделение массива [47, 23, 81, 12, 56, 33, 95] (индексы 0-6)
...
4. ЛИНЕЙНЫЙ ПОИСК
========================================
Начало линейного поиска элемента 47
Массив для поиска: [12, 23, 33, 47, 56, 81, 95]
  Проверяем элемент 12 на позиции 0
  Проверяем элемент 23 на позиции 1
  Проверяем элемент 33 на позиции 2
  Проверяем элемент 47 на позиции 3
  Элемент 47 найден на позиции 3!
РЕЗУЛЬТАТ: элемент найден на позиции 3

========================================
5. ПОИСК ФИБОНАЧЧИ
========================================
Начало поиска Фибоначчи элемента 47
Отсортированный массив: [12, 23, 33, 47, 56, 81, 95]
Вычисляем числа Фибоначчи:
  F(m-2)=0, F(m-1)=1, F(m)=1
  F(m-2)=1, F(m-1)=1, F(m)=2
  F(m-2)=1, F(m-1)=2, F(m)=3
  F(m-2)=2, F(m-1)=3, F(m)=5
  F(m-2)=3, F(m-1)=5, F(m)=8
Наибольшее число Фибоначчи <= 7: F(m)=5
РЕЗУЛЬТАТ: элемент найден на позиции 3
Программа 
